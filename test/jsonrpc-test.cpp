...
class JsonRpcTest : public cxxtools::unit::TestSuite
{
    ...
    public:
            ...
            _port(7003)
        {
            ...
            registerMethod("Multiple", *this, &JsonRpcTest::Multiple);
        ...
        void setUp()
        {
            ...
            _server = new cxxtools::json::RpcServer(_loop, _listen, _port);
        ...
        void Nothing()
        {
            ...
            cxxtools::json::RpcClient client(_loop, _listen, _port);
        ...
        void ConnectError()
        {
            ...
            cxxtools::json::RpcClient client(_loop, _listen, _port + 1);
            cxxtools::RemoteProcedure<bool> multiply(client, "multiply");
        ...
        void Multiple()
        {
            ...
            std::vector<cxxtools::json::RpcClient> clients;
            ...
            {
                clients.push_back(cxxtools::json::RpcClient(_loop, _listen, _port));
