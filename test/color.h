...
#ifndef CXXTOOLS_COLOR_H
#define CXXTOOLS_COLOR_H
...
inline void operator >>=(const cxxtools::SerializationInfo& si, Color& color)
{
...
inline void operator <<=(cxxtools::SerializationInfo& si, const Color& color)
{
