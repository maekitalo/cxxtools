...
#ifndef CXXTOOLS_JSON_CLIENT_H
#define CXXTOOLS_JSON_CLIENT_H

#include <cxxtools/json/api.h>
...
class CXXTOOLS_JSON_API Client : private NonCopyable
{
        ClientImpl* _impl;
    ...
    public:
        ...
        Delegate<std::size_t, Client&> bodyAvailable;
